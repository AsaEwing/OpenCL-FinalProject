...
//一維轉二維(有平行)
void parallel_in1_out2(int arrayXY, int dirTmp, int modAngle, float** out1_array, float** out1_array2, float* out2_array2){
    /*
    tmpConst[]
    0   tmpSin
    1   tmpCos
...
//一維轉二維(無平行)
void in1_out2(int arrayXY, int dirTmp, int modAngle, float** out1_array, float** out1_array2, float* out2_array2){
    //int tmpAngle = dirTmp*modAngle;         //角度
