...
int main(int argc, const char * argv[]) {
    ...
    Mat Image1=imread("image/mid11.png",1);
    Mat Image2=imread("image/mid21.png",1);
    ...
    std::cout << "h3, w3: " << SizeOut.height << ", " << SizeOut.width << "\n";
    std::cout << "DataSize 1: " << DATA_SIZE1 << "\n";
    std::cout << "DataSize 2: " << DATA_SIZE2 << "\n";
    std::cout << "WorkSize 1: " << work_size << "\n\n";
    std::cout << "Type: " << Image1.type() << ", "  << Image1.depth() << ", "  << Image1.channels() << "\n";
    std::cout << "Type: " << Image2.type() << ", "  << Image2.depth() << ", "  << Image2.channels() << "\n";
    std::cout << "Type: " << OutImage.type() << ", "  << OutImage.depth() << ", "  << OutImage.channels() << "\n\n";
...
/////////////////////////////////////////////////////////
    ...
    cl_program program = load_program(context, "shader4.cl");
    if(program == 0) {
